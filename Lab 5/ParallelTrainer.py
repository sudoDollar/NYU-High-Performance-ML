...
class ParallelTrainer:
    ...
    def __init__(self, model, num_gpus:int):
        ...
        self.model = nn.DataParallel(deepcopy(model), self.device_ids)
        self._model = model
    ...
    def train(self, epochs):
        ...
        print("Number of Devices: {}, Batch Size per GPU: {}".format(self.num_gpus, self.train_loader.batch_size//self.num_gpus))
    ...
    def reset(self):
        self.model = nn.DataParallel(deepcopy(self._model), self.device_ids)
        self.optimizer = None
